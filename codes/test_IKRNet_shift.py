...
import options.options as option_IKRNet
...
def main():
    ...
    opt_P = option_IKRNet.parse(args.opt_P, is_train=True)
    opt_C = option_IKRNet.parse(args.opt_C, is_train=True)

    # convert to NoneDict, which returns None for missing keys
    opt_P = option_IKRNet.dict_to_nonedict(opt_P)
    opt_C = option_IKRNet.dict_to_nonedict(opt_C)
