...
#model_file = '../experiments/USR4it_bldker_USRfine/models/models_P2/F_135000.pth'
model_file = '../experiments/USR8it_bldker_noise_sc2/models/F_22000.pth'
        ...
        #for filt_ind in [11]:
            ...
            if (1):
                ...
                for _, val_data in enumerate(val_loader):
                    ...
                    with torch.no_grad():
                        SR_img, ker_est, b_check, est_ker_map = model_SR(val_data['GT'].to(device), b_kernels, opt_P['scale'], sigma, val_data['GT'], SR_it, ker_it) 
