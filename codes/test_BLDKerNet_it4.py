...
from models.BLDSRnet_v2_it4 import BLDKerNet as net
...
#o documemodel_file = '../experiments/USR8it_bldker_noise_sc2/models/models_p2/F_10000.pth'
model_file = '../experiments/USR4it_bldker_USRfine/models/models_P2/F_135000.pth'
#model_file = '../experiments/USR8it_bldker_noise_sc2/models/F_54000.pth'
#model_file = '../experiments/USR8it_bldker_noise_free_sc2/models/F_18000.pth'
model_file = '../experiments/USR4it_bldker_USRfine/models/F_128000.pth'
...
def BLDSRnet(opt_P, opt_C):
    ...
    # #Npretrained_dict_init = {k : v for (k, v) in pretrained_dict.items() if ((k[0:2]=='p.') or (k[0:2]=='h.'))}
