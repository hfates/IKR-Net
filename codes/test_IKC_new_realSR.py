...
def main():
    ...
    crop_size = opt_P['scale']**2 #opt_P['crop_border'] 
        ...
        for filt_ind in sel_ker:
            ...
            if (1):
                ...
                for _, val_data in enumerate(val_loader):
                    ...
                    img_dir = dataset_dir+"/"+str(filt_ind+1)
                    ...
                    for step_C in range(opt_C['step']):
                        ...
                        model_F.feed_data(val_data, val_data['GT'].to(device), est_ker_map)
                        model_F.test()
                    ...
                    #sr_img = util.tensor2img(F_visuals['SR'])  # uint8                    #sr_img = util.tensor2img(ker_est.detach().cpu())  # uint8
