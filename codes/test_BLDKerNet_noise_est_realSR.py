        ...
        #for filt_ind in [11]:
            ...
            if (1):
                ...
                for _, val_data in enumerate(val_loader):
                    ...
                    img_dir = opt_P['path']['val_images']+"/real_scale"+str(sc_final)+"/"+str(filt_ind+1)
                    ...
                    with torch.no_grad():
                        SR_img, ker_est, b_check, est_ker_map, est_noise = model_SR(val_data['GT'].to(device), b_kernels, opt_P['scale'], sigma, max_noise, val_data['GT'], SR_it, ker_it) 
