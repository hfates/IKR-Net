...
##########################
model_no = 127 #88 for sc4, 127 for sc2
val_noise =  0.02
is_val_noise = True
...
def main():
    ...
    args = Namespace(batch_size=32, beta1=0.9, beta2=0.999, blur_kernel=21, blur_type='aniso_gaussian', noise=0.0,scale=[2.0],
        ...
        for filt_ind in sel_ker:
            ...
            if (1):
                ...
                for _, val_data in enumerate(val_loader):
                    ...
                    with torch.no_grad():
                        SR_img = DASR(val_data['GT'].to(device) * 255)
                        SR_img /= 255.0
                    # with torch.no_grad():
